...
计算冻结时的生产源码提交为 `b830ffffc764789c209ce04566c2c9ceb851f175`；按用户要求统一提交身份后，内容完全相同的生产源码提交为 `fabac511be255a12a6793eb74ce00b10b313a527`。原始冻结记录保留计算时的提交号，完整对应关系和内容一致性校验见 [COMMIT_PROVENANCE.md](COMMIT_PROVENANCE.md)。研究入口、配置、队列和报告也纳入最终源码归档。
