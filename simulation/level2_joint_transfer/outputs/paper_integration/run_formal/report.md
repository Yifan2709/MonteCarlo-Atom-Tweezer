...
| R2 | done | ran | structural_pass | platform=0.9738(paper raw 0.948) DD on/off=0.9704/0.9508 |
...
| Y2 | done | ran | anchor_pass | optimal/trip=8.88e-04(bound 6e-4) |
| Y3 | done | ran | anchor_pass | RT1=0.0127(paper 0.011) frac RT1/RT5=0.56/0.07(paper 0.5/0.1) |
| Y4 | done | ran | anchor_pass | slope AR/TO=4.00/2.00 erasure AR=0.38(paper 0.38) |
...
| Y6 | done | ran | ordering_pass | adaptive/random/ps=0.912/0.894/0.929(paper 0.802/0.771/0.87); 水平差 ~+0.110（见报告归因） |
| I1 | done | ran | n/a(接通)_pass | yb=True rb=True |
